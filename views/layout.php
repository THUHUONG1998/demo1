...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/bootstrap.min.css">

  <!-- font-awesome & simple line icons CSS -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/font-awesome.css" media="all">
  <link rel="stylesheet" type="text/css" href="public/sources/css/simple-line-icons.css" media="all">

  <!-- owl.carousel CSS -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/owl.carousel.css">
  <link rel="stylesheet" type="text/css" href="public/sources/css/owl.theme.css">
  <link rel="stylesheet" type="text/css" href="public/sources/css/owl.transitions.css">

  <!-- animate CSS  -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/animate.css" media="all">

  <!-- flexslider CSS -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/flexslider.css">

  <!-- jquery-ui.min CSS  -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/jquery-ui.css">

  <!-- Revolution Slider CSS -->
  <link href="public/sources/css/revolution-slider.css" rel="stylesheet">

  <!-- style CSS -->
  <link rel="stylesheet" type="text/css" href="public/sources/css/style.css" media="all">
</head>
<!-- Header -->
<header>
            ...
            <div class="col-sm-3 col-md-3 col-xs-12">
              ...
              <div class="logo">
                <a title="e-commerce" href="index.php">
                  <img alt="responsive theme logo" src="public/sources/images/logo.png">
                </a>
              </div>
              <!-- End Header Logo -->
            </div>
            ...
            <div class="col-sm-6 col-xs-12">
              <div class="payment">
                <ul>
                  <li>
                    <a href="#">
                      <img title="Visa" alt="Visa" src="public/sources/images/visa.png">
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img title="Paypal" alt="Paypal" src="public/sources/images/paypal.png">
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img title="Discover" alt="Discover" src="public/sources/images/discover.png">
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img title="Master Card" alt="Master Card" src="public/sources/images/master-card.png">
                    </a>
                  </li>
                </ul>
              </div>
...
<!-- bootstrap js -->
<script type="text/javascript" src="public/sources/js/bootstrap.min.js"></script>


<!-- owl.carousel.min js -->
<script type="text/javascript" src="public/sources/js/owl.carousel.min.js"></script>

<!-- bxslider js -->
<script type="text/javascript" src="public/sources/js/jquery.bxslider.js"></script>

<!-- Slider Js -->
<script type="text/javascript" src="public/sources/js/revolution-slider.js"></script>

<!-- megamenu js -->
<script type="text/javascript" src="public/sources/js/megamenu.js"></script>
...
<script type="text/javascript" src="public/sources/js/mobile-menu.js"></script>

<!--jquery-ui.min js -->
<script type="text/javascript" src="public/sources/js/jquery-ui.js"></script>

<!-- main js -->
<script type="text/javascript" src="public/sources/js/main.js"></script>

<!-- countdown js -->
<script type="text/javascript" src="public/sources/js/countdown.js"></script>
...
<script type="text/javascript">
  ...
  jQuery (document).ready(function(){// load trang web
    $('.add-to-cart-mt').click(function(){// su kien click vao class add-to-cart-mt
      let id = $(this).attr('data-id')// this la chinh no
      $.ajax({
        url:'cart.php',
        type : 'POST',
        data :{
    ...
    $('.button-cart').click(function (res) {
      let id = $(this).attr('data-id')
      $.ajax({
        url:'cart.php',
        type : 'POST',
